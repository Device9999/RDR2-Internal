...
namespace GRAPHICS
{
	...
	static void _RESET_TOGGLE_PAUSED_RENDERPHASES_STATUS() { invoke<Void>(0xCCD9AAD85E1B559E); } // 0xCCD9AAD85E1B559E b1207
...
namespace MISC
{
	...
	static void _0x67943537D179597C(float x, float y, float z) { invoke<Void>(0x67943537D179597C, x, y, z); } // 0x67943537D179597C b1207
	...
	static BOOL GET_GROUND_Z_FOR_3D_COORD(float x, float y, float z, float* groundZ, Any b) { return invoke<BOOL>(0x24FA4267BB8D2431, x, y, z, groundZ, b); } // 0x24FA4267BB8D2431 b1207
	...
	static BOOL _0x268AB8420A9E4ED7() { return invoke<BOOL>(0x268AB8420A9E4ED7); } // 0x268AB8420A9E4ED7 b1207
	...
	static void _INT_TO_STRING(int value, const char* format, char* buffer) { invoke<Void>(0xCF11C0CEB40C401B, value, format, buffer); } // 0xCF11C0CEB40C401B b1207
	...
	static const char* _CREATE_COLOR_STRING(int rgb) { return invoke<const char*>(0xBCC2CFADEA1AEA6C, rgb); } // 0xBCC2CFADEA1AEA6C b1207
...
namespace OBJECT
{
	...
	static Object CREATE_OBJECT(Hash modelHash, float x, float y, float z, BOOL networkHandle, BOOL createHandle, BOOL dynamic) { return invoke<Object>(0x509D5878EB39E842, modelHash, x, y, z, networkHandle, createHandle, dynamic); } // 0x509D5878EB39E842 b1207
	...
	static Pickup CREATE_AMBIENT_PICKUP(Hash pickupHash, float posX, float posY, float posZ, int p4, int value, Hash modelHash, BOOL p7, BOOL p8) { return invoke<Pickup>(0x673966A0C0FD7171, pickupHash, posX, posY, posZ, p4, value, modelHash, p7, p8); } // 0x673966A0C0FD7171 b1207
...
namespace PED
{
	static Ped CREATE_PED(Hash modelHash, float x, float y, float z, float heading, BOOL isNetwork, BOOL thisScriptCheck, Any p8) { return invoke<Ped>(0xD49F9B0955C367DE, modelHash, x, y, z, heading, isNetwork, thisScriptCheck, p8); }
	...
	static void APPLY_DAMAGE_TO_PED(Ped ped, int damageAmount, BOOL armorFirst) { invoke<Void>(0x697157CED63F18D4, ped, damageAmount, armorFirst); }  // 0x697157CED63F18D4 b1207
	...
	static int GET_PED_NEARBY_PEDS(Ped ped, int* sizeAndPeds, int ignore) { return invoke<int>(0x23F8F5FC7E8C4A6B, ped, sizeAndPeds, ignore); } // 0x23F8F5FC7E8C4A6B b1207
	...
	static void SET_PED_VISIBLE(Ped p0, BOOL p1) { invoke<Void>(0x283978A15512B2FE, p0, p1); } // 0x283978A15512B2FE b1207
	...
	static void SET_PED_STAMINA(Ped p0, float p1) { invoke<Void>(0x675680D089BFA21F, p0, p1); } // 0x675680D089BFA21F b1207
...
namespace PLAYER
{
	...
	static void SET_PLAYER_MODEL(Player player, Hash modelHash, BOOL p2) { invoke<Void>(0xED40380076A31506, player, modelHash, p2); } // 0xED40380076A31506 b1207
	...
	static void START_PLAYER_TELEPORT(Player player, float x, float y, float z, float heading, BOOL keepVehicle, BOOL keepVelocity, BOOL fadeInOut) {

		invoke<Void>(0xDF8822C55EDDA65B, player, x, y, z, heading, keepVehicle, keepVelocity, fadeInOut);
	}
...
namespace STATS
{
	...
	static BOOL STAT_ID_SET_INT(Hash statName, int value, BOOL save) { return invoke<BOOL>(0xA4DDF5DF95E65EEE, statName, value, save); } // 0xA4DDF5DF95E65EEE b1207
...
namespace TASK
{
	...
	static void TASK_AIM_GUN_AT_ENTITY(Ped ped, Entity entity, int duration, BOOL p3, BOOL p4) { invoke<Void>(0x9B53BB6E8943AF53, ped, entity, duration, p3, p4); } // 0x9B53BB6E8943AF53 b1207
	...
	static void CLEAR_PED_TASKS_IMMEDIATELY(Ped p0, Any p1, Any p2) { invoke<Void>(0xAAA34F8A7CB32098, p0, p1, p2); } // 0xAAA34F8A7CB32098 b1207
...
namespace WEAPON
{
	...
	static BOOL GET_MAX_AMMO(Ped ped, int* ammo, Hash weaponHash) { return invoke<BOOL>(0xDC16122C7A20C933, ped, weaponHash, ammo); } // 0xDC16122C7A20C933 b1207
	...
	static BOOL _GIVE_WEAPON_TO_PED_2(Ped ped, Hash weaponHash, int ammoCount, BOOL equipNow, BOOL p4, int weaponGroup, BOOL p6, float p7, float p8, int p9, BOOL p10, float p11, BOOL p12)
	{
		return invoke<BOOL>(0x5E3BDDBCB83F3D84, ped, weaponHash, ammoCount, equipNow, p4, weaponGroup, p6, p7, p8, p9, p10, p11, p12);
	}
	...
	static BOOL GET_CURRENT_PED_WEAPON(Any p0, Hash* p1, Any p2, Any p3, Any p4) { return invoke<BOOL>(0x3A87E44BB9A01D54, p0, p1, p2, p3, p4); } // 0x3A87E44BB9A01D54 b1207
	...
	//static void GIVE_DELAYED_WEAPON_TO_PED(Ped ped, Hash weaponHash, int time, BOOL equipNow) { invoke<Void>(0xB282DC6EBD803C75, ped, weaponHash, time, equipNow); } // 0xB282DC6EBD803C75 b1207
	//static void GIVE_DELAYED_WEAPON_TO_PED(Ped ped, Hash weaponHash, int ammoCount, BOOL equipNow, Any p4) { invoke<Void>(0xB282DC6EBD803C75, ped, weaponHash, ammoCount, equipNow, p4); }//0xB282DC6EBD803C75
	//static void GIVE_DELAYED_WEAPON_TO_PED(Ped ped, Hash weaponHash, int ammoCount, BOOL equipNow) { invoke<Void>(0xB282DC6EBD803C75, ped, weaponHash, ammoCount, equipNow); } // 0xB282DC6EBD803C75 b1207
	...
	static BOOL GET_PED_LAST_WEAPON_IMPACT_COORD(Ped ped, vector_3_aligned* coords) { return invoke<BOOL>(0x6C4D0409BA1A2BC2, ped, coords); } // 0x6C4D0409BA1A2BC2 b1207
...
enum WeaponGroup : uint32_t
{
	_Revolver = 0xBE5B8969,
	_Pistol = 0x18D5FA97,
	_Animal = 0xA00FC1E4,
	_Melee = 0xD49321D4,
	_MeleeThrowable = 0x5C4C5883,
	_Shotgun = 0x33431399,
	_SniperRifle = 0xB7BBD827,
	_Kit = 0xC715F939,
	_Rifle = 0x39D5C192,
	_Bow = 0xB5FD67CD,
	_Lasso = 0x126210C3,
	_Repeater = 0xDC8FB3E9,
	_FishingRod = 0x60B51DA4
};
...
static uint32_t repeaters[5] = {
	RepeaterCarbine,
	RepeaterWinchesterJohn,
	RepeaterCarbineSadie,
	RepeaterWinchester,
	RepeaterHenry 
};

static uint32_t bows[2] = {
	Bow,
	BowCharles
};

static uint32_t rifles[4] = {
	RifleBoltactionBill,
	RifleBoltaction,
	RifleSpringfield,
	RifleVarmint
...
static uint32_t sniper_rifles[4] = {
	SniperrifleRollingblockLenny,
	SniperrifleRollingblock,
	SniperrifleCarcano,
	SniperrifleRollingblockExotic
};


static uint32_t shotguns[9] = {
	ShotgunDoublebarrel ,
	ShotgunSawedoffCharles ,
	ShotgunSemiautoHosea ,
	ShotgunDoublebarrelUncle ,
	ShotgunSawedoff ,
	ShotgunPump ,
	ShotgunSemiauto ,
	ShotgunRepeating ,
	ShotgunDoublebarrelExotic
};

static uint32_t pistols[4] =
{
	PistolVolcanic,
	PistolSemiauto,
	PistolMauser,
...
static uint32_t meelees[35] =
{
	...
	MeleeKnifeVampire,
	MeleeTorch,
	MeleeLanternElectric,
	MeleeHatchet,
	MeleeAncientHatchet,
	MeleeCleaver,
	MeleeHatchetDoubleBit,
	MeleeHatchetDoubleBitRusted,
	MeleeHatchetHunter,
	MeleeHatchetHunterRusted,
	MeleeHatchetViking,
	MeleeTorchCrowd,
	MeleeHatchetMeleeonly
};

static uint32_t throwables[6] =
{
	ThrownTomahawk,
	ThrownThrowingKnivesJavier,
	ThrownThrowingKnives,
	ThrownMolotov ,
	ThrownDynamite ,
	ThrownTomahawkAncient 
};

static std::string weapons_names[48]
{
	"WEAPON_MOONSHINEJUG",
